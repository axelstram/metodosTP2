...
\begin{itemize}
\item Al testear el funcionamiento del algoritmo PageRank con la estructura de matriz Column Sparse Row, notamos que el tiempo de carga era demasiado lento. En la sección de Análisis de Estructuras, detallamos más acerca de esta problemática.
\end{itemize}
